<div class="card-header py-3 border-bottom-danger">
	<div class="row">
		<div class="col-md-10"> 
			<h3 class="m-0 font-weight-bold text-gray-600">Marketing Request Permission</h3>
			</div>
		<div class="col-md-2">
		</div>
	</div>
...
<div class="card-body">
	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				<div class="card-header text-light font-weight-bold" id="headingFilter" title="Sending email approval to GM's">Email Recipients</div>
				<div class="table-responsive" style="min-height: 250px;">
					<table id="emaillist" class="table table-sm table-bordered no-footer table-hover display nowrap" width="100%">
